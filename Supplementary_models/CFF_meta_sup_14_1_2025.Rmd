...
ter_models <-   read.mulTree(mulTree.chain = "cff_terr_sup_models", 
                              convergence = FALSE, 
                              model = FALSE,
                              extract = NULL)


ter_models_sp <-   read.mulTree(mulTree.chain = "cff_terr_sup_models", 
                              convergence = FALSE, 
                              model = FALSE,
                              extract = "VCV")
